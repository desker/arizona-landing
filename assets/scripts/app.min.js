...
/***/ function(module, exports, __webpack_require__) {
	...
	var _portfolio = __webpack_require__(57);
	
	var _portfolio2 = _interopRequireDefault(_portfolio);
	
	var _searchQueries = __webpack_require__(59);
	
	var _searchQueries2 = _interopRequireDefault(_searchQueries);
	
	var _team = __webpack_require__(60);
	...
	(0, _jquery2.default)(function () {
		...
		_searchQueries2.default.init();
		_team2.default.init();
	
		_modal2.default.init();
		_input2.default.init();
		(0, _jquery2.default)('input[name=nav]').change(function (e) {
			var value = e.target.value;
			(0, _jquery2.default)('.js-layer-icon').attr('data-icon-checked', value);
		});
	
		(0, _jquery2.default)('.js-work-expand').on('click', function () {
			(0, _jquery2.default)('.work-stages__stage').addClass('visible');
		});
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function () {
		...
		(0, _createClass3.default)(Modal, [{
			key: 'init',
			value: function init() {
				(0, _jquery2.default)('body').on('click', '.js-show-modal', this.handleClickShow.bind(this));
				(0, _jquery2.default)('body').on('click', '.js-hide-modal', this.handleClickHide.bind(this));
			}
		}, {
			key: 'showModal',
			value: function showModal(id) {
				var $modal = (0, _jquery2.default)('.js-modal' + id);
				($modal.data('beforeShow') || []).map(function (item) {
					return typeof item.cb === 'function' && item.cb(item.elem, $modal);
				});
				$modal.show({
					done: function done() {
			...
			key: 'handleClickShow',
			value: function handleClickShow(e) {
				e.preventDefault();
			...
			key: 'handleClickHide',
			value: function handleClickHide(e) {
				e.preventDefault();
				var $modal = (0, _jquery2.default)(e.currentTarget).parents('.js-modal');
				this.hideModal($modal);
			}
		}, {
			key: 'beforeShow',
			value: function beforeShow(elem, cb) {
				var $el = (0, _jquery2.default)(elem);
				var $modal = $el.hasClass('js-modal') ? $el : $el.parents('.js-modal');
				if (!$modal.length) {
					return;
				}
				$modal.data('beforeShow', ($modal.data('beforeShow') || []).concat({ cb: cb, elem: elem }));
			}
		}]);
		return Modal;
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function () {
		...
		(0, _createClass3.default)(Header, [{
			key: 'init',
			value: function init() {
				(0, _jquery2.default)('body').on('click', '.js-header-nav', this.handleClick);
			}
		}, {
			key: 'handleClick',
			value: function handleClick(e) {
				...
				var id = $el.attr('href');
				var $target = (0, _jquery2.default)(id);
				if (!$target.length) {
					return;
				}
				var top = $target.offset().top;
				(0, _jquery2.default)('html, body').animate({ scrollTop: top }, 600, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends4 = __webpack_require__(49);
	...
	var Input = function () {
		...
		(0, _createClass3.default)(Input, [{
			...
			value: function init() {
				...
				(0, _jquery2.default)('input[data-mask]').each(this.initNumbered);
	
				(0, _jquery2.default)('.js-form').each(function (i, form) {
					return _modal2.default.beforeShow(form, _this.initForm.bind(_this));
				}).on('submit', this.handleSubmit.bind(this));
				(0, _jquery2.default)('.js-form input').on('focus blur change input', this.validateField.bind(this));
			}
		}, {
			key: 'initForm',
			value: function initForm(form) {
				var $form = (0, _jquery2.default)(form).removeClass('submit-success submit-error');
				form.reset();
				var valid = {};
			...
			value: function handleSubmit(e) {
				...
				var data = $el.addClass('submitting').serializeArray().reduce(function (acc, _ref) {
					var name = _ref.name,
					    value = _ref.value;
					return (0, _extends5.default)({}, acc, (0, _defineProperty3.default)({}, name, value));
				}, {});
				...
				_jquery2.default.ajax(options).always(this.onSubmit.bind($el));
			}
		}, {
			key: 'onSubmit',
			value: function onSubmit(data, status, error) {
				var $form = this;
			...
			key: 'updateValidFields',
			value: function updateValidFields($form) {
				var fields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	
				var data = (0, _extends5.default)({}, $form.data('validFields') || {}, fields);
				var valid = (0, _keys2.default)(data).reduce(function (acc, key) {
					return acc && data[key];
				}, true);
				$form.data('validFields', data).toggleClass('invalid', !valid).find('*[type="submit"]').prop('disabled', !valid);
			}
		}, {
			key: 'validateField',
			value: function validateField(e) {
				var $form = (0, _jquery2.default)(e.target).parents('.js-form');
				var valid = (0, _defineProperty3.default)({}, e.target.name, this.isValid(e.target));
				this.updateValidFields($form, valid);
			}
		}, {
			key: 'isValid',
			value: function isValid(elem) {
				...
				if ($el.data('numbered')) {
					var validMask = $el.data('numbered').validate();
			...
			key: 'initNumbered',
			value: function initNumbered() {
				var $el = (0, _jquery2.default)(this);
				var attrs = ['mask', 'numbered', 'empty', 'placeholder'];
				var options = attrs.reduce(function (acc, attr) {
					return $el.attr('data-' + attr) ? (0, _extends5.default)({}, acc, (0, _defineProperty3.default)({}, attr, $el.attr('data-' + attr))) : acc;
				}, {});
	
				var numbered = new _input2.default($el, options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! numbered v1.0.6 | pavel-yagodin | MIT License | https://github.com/CSSSR/jquery.numbered */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Portfolio = function () {
		...
		(0, _createClass3.default)(Portfolio, [{
			key: 'init',
			value: function init() {
				(0, _jquery2.default)('.js-portfolio-carousel').slick({
					arrows: false,
					dots: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchQueries = function () {
		function SearchQueries() {
			(0, _classCallCheck3.default)(this, SearchQueries);
		}
	
		(0, _createClass3.default)(SearchQueries, [{
			key: 'init',
			value: function init() {
				(0, _jquery2.default)('.js-select-query').on('click', function () {
					(0, _jquery2.default)(this).removeClass('flash');
				});
				(0, _jquery2.default)('.js-select-query').change(this.handleChange);
			}
		}, {
			key: 'handleChange',
			value: function handleChange(e) {
				var value = e.target.value;
				var id = '#' + value;
				var selectedClass = 'searchQueries__image-outer_selected';
				(0, _jquery2.default)('.js-query-image').not(id).removeClass(selectedClass);
				(0, _jquery2.default)(id).addClass(selectedClass);
			}
		}]);
		return SearchQueries;
	}();
	
	exports.default = new SearchQueries();
	...
	var Team = function () {
		...
		(0, _createClass3.default)(Team, [{
			...
			value: function init() {
				...
				this.switchWidth = 0;
				(0, _jquery2.default)('.js-team-person').each(function (i, item) {
					_this.switchWidth += (0, _jquery2.default)(item).outerWidth(true);
				});
				(0, _jquery2.default)('body').on('change', 'input[name="person"]', this.handleChangeItem.bind(this));
				this.initCarousel();
				(0, _jquery2.default)(window).resize(this.initCarousel.bind(this));
			}
		}, {
			key: 'initCarousel',
			value: function initCarousel() {
				...
				var initialSlide = Number((0, _jquery2.default)('input[name="person"]:checked').val()) || 0;
				(0, _jquery2.default)('.js-team-carousel').addClass('with-carousel').on('afterChange', this.afterChangeSlide.bind(this)).on('destroy', this.onUnslick.bind(this)).slick({
					arrows: false,
					dots: false,
					slidesToShow: 1,
					centerPadding: '100px',
			...
			value: function handleChangeItem(e) {
				var value = Number(e.target.value);
				if (this.isCarousel) {
					(0, _jquery2.default)('.js-team-carousel').slick('slickGoTo', value);
				}
			}
		}, {
			key: 'afterChangeSlide',
			value: function afterChangeSlide(e, slick, slide) {
				if (!this.isCarousel) {
					return;
				}
				(0, _jquery2.default)('input[name="person"][value="' + slide + '"]').prop('checked', true);
			}
		}, {
			key: 'onUnslick',
			value: function onUnslick() {
				this.isCarousel = false;
				(0, _jquery2.default)('.js-team-carousel').removeClass('with-carousel');
			}
		}, {
			key: 'isNeedSlick',
			value: function isNeedSlick() {
				var $elem = (0, _jquery2.default)('.js-team-carousel');
